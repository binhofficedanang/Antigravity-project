...
def main():
    with sync_playwright() as p:
        ...
        page.screenshot(path="thuviennhadat_step2_success.png", full_page=True)
        print("Đã chụp màn hình trang Bước 2 vào thuviennhadat_step2_success.png")
        
        # Lưu HTML trang bước 2
        html_content = page.content()
        with open("thuviennhadat_step2_success.html", "w", encoding="utf-8") as f:
            f.write(html_content)
        print("Đã lưu cấu trúc HTML trang Bước 2 thành công vào thuviennhadat_step2_success.html")
