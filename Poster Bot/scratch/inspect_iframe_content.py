...
def main():
    ...
    try:
        ...
        time.sleep(1.5)
        bot.page.select_option("#huyen", "584")
        time.sleep(1.5)
        ...
        # Let's see if there is an onclick handler or a button
        # On ASP.NET sites with iframe targets, clicking the button or calling form.submit() triggers the target
